...
import com.example.JwtFilter.JwtFilter;
...
public class SecurityConfig {
    ...
    // this bean is required for creating token in Authentication controller
    @Bean
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/role/create", "/api/user/create", "/api/authenticate").permitAll()
